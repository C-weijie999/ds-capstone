...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        selected_df=selected_df.groupby(['Launch Site','class']).size().reset_index(name='class count')
        fig=px.pie(selected_df,values='class count',names='class',title=f'Total Success Launches for site {entered_site}')
        return fig
